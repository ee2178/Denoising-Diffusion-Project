...
#SBATCH --mem=32GB
#SBATCH --time=4:00:00
#SBATCH --job-name=ImMAP_Eval_LPDSNet
...
python3 eval_diff.py config.json --kspace_path=../../datasets/fastmri/brain/multicoil_val --smap_path=../../datasets/fastmri_preprocessed/brain_T2W_coil_combined/val/ --noise_level=0.05
